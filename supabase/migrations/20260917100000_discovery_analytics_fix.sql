-- DISCOVERY ANALYTICS FIX
-- Root cause: migration 20260916 never applied to production.
-- Columns country/discovery_source/discovery_other do NOT exist in production profiles table.
-- The handle_new_user() trigger in production is the old version (no discovery columns).
-- This migration fixes BOTH: adds columns + replaces trigger.
...
-- 2. Replace handle_new_user() with version that saves discovery fields
